...
public class FixedHttp11Processor extends AbstractProcessor {
     ...
     */
    private static final StringManager sm = StringManager.getManager(FixedHttp11Processor.class);
    ...
    public FixedHttp11Processor(AbstractHttp11Protocol<?> protocol, Adapter adapter) {
        super(adapter);
